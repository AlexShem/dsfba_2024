...
> and is a better statistician than a computer scientist."
>
...
* \redbf{Wikipedia: } "the extraction of knowledge from data"
...
* Instructor: [Professor Alex](mailto:aleksandr.shemendyuk@unil.ch).
* Teaching assistants
    * [Ilia Azizi](mailto:ilia.azizi@unil.ch)
    * [Léo Wenger](mailto:leo.wenger@unil.ch)
    * [Elwin Freudiger](elwin.freudiger@unil.ch)
...
* Multiple choice questions:
    ...
    * Worst grade __might__ be dropped
* Project:
    * Project proposal (5%)
    * Project update (5%)
...
* Course website:
    * \redbf{\url{https://moodle.unil.ch/course/view.php?id=29021}} <!-- LOL --> #TODO: update link
    * Registration key: \redbf{dsfba\_2023} <!-- LOL --> #TODO: update key
    * __A discussion forum__
...
* Technical features:
    * \redbf{Available for Windows, macOS, and Linux} <!-- LOL -->
    ...
    * \redbf{Wide variety of statistical and graphical techniques} <!-- LOL -->
    * \redbf{Easily extensible through functions and packages} <!-- LOL -->
    * \redbf{Read/write from/to various data sources} <!-- LOL -->
...
\redcbf{\href{https://fantasyfootballanalytics.net/2014/01/why-r-is-better-than-excel.html}{source: fantasyfootballanalytics.net}}
...
\redcbf{\href{https://github.com/jdwilson4/Intro-Data-Science}{source: github.com/jdwilson4}}

## ...but not everything


\redcbf{R's advantages:}

:::: {.columns}
::: {.column width='48%'}

* \redbf{Easier automation} <!-- LOL -->
* \redbf{Better reproducibility} <!-- LOL -->
* Faster computation
...
\redcbf{\href{https://trendct.org/2015/06/12/r-for-beginners-how-to-transition-from-excel-to-r/}{source: trendct.org}}
...
\redcbf{\href{https://cran.r-project.org/}{source: cran.r-project.org}}
...
```
\redcbf{\href{https://posit.co/products/open-source/rstudio/}{source: rstudio.com}}
...
>
> "The package named base is in a way the core of R and contains the basic functions of the language,
...
* Often perform the same tasks as `Base R`, but:
    * Relies on a __pipe__ operator to help with the flow of the code.
