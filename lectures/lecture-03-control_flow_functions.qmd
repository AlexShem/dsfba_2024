...
* Generally speaking you shouldn't need to use `for` loops for \bluebf{data analysis tasks}, we'll see better solutions.
...
knitr::include_graphics("../assets/functionals/map-arg-recycle.png")
```
...
```{r, echo = FALSE, out.width="100%"}
knitr::include_graphics("../assets/functionals/pmap-3.png")
```
...
```{r, echo = FALSE, out.width="40%"}
knitr::include_graphics("../assets/functionals/reduce.png")
```
